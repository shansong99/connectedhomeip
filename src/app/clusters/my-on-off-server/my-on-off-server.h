...
{
public:
    using Feature = chip::app::Clusters::MyOnOff::Feature;

    /**********************************************************
     * Functions Definitions
     *********************************************************/

    static MyOnOffServer & Instance();
...
struct MyOnOffEffect
{
    using OffWithEffectTriggerCommand = void (*)(MyOnOffEffect *);
    using EffectVariantType           = std::underlying_type_t<chip::app::Clusters::MyOnOff::OnOffDelayedAllOffEffectVariant>;
    static_assert(
        std::is_same<EffectVariantType, std::underlying_type_t<chip::app::Clusters::MyOnOff::OnOffDyingLightEffectVariant>>::value,
        "chip::app::Clusters::MyOnOff::OnOffDelayedAllOffEffectVariant and "
        "chip::app::Clusters::MyOnOff::OnOffDyingLightEffectVariant underlying types differ.");

    chip::EndpointId mEndpoint;
    OffWithEffectTriggerCommand mOffWithEffectTrigger = nullptr;
    chip::app::Clusters::MyOnOff::OnOffEffectIdentifier mEffectIdentifier;
    EffectVariantType mEffectVariant;
    MyOnOffEffect * nextEffect = nullptr;

    MyOnOffEffect(chip::EndpointId endpoint, OffWithEffectTriggerCommand offWithEffectTrigger,
                  chip::app::Clusters::MyOnOff::OnOffEffectIdentifier effectIdentifier =
                      chip::app::Clusters::MyOnOff::OnOffEffectIdentifier::kDelayedAllOff,
                   ...
                   */
                  EffectVariantType =
                      chip::to_underlying(chip::app::Clusters::MyOnOff::OnOffDelayedAllOffEffectVariant::kFadeToOffIn0p8Seconds));
    ~MyOnOffEffect();

    bool hasNext() { return this->nextEffect != nullptr; }

    MyOnOffEffect * next() { return this->nextEffect; }

    void setNext(MyOnOffEffect * inst) { this->nextEffect = inst; }
};
 ...
 */
void emberAfPluginMyOnOffClusterServerPostInitCallback(chip::EndpointId endpoint);
